...
const LEVEL3_GUARDS = [
  createGuard({
    ...
    fovDeg: 74,
    waypoints: [
      level3Waypoint(26, 16),
      level3Waypoint(38, 16),
      level3Waypoint(38, 24),
      level3Waypoint(26, 24),
    ],
  }),
  createGuard({
  ...
  createGuard({
    ...
    fovDeg: 70,
    waypoints: [
      level3Waypoint(30, 13),
      level3Waypoint(35, 13),
      level3Waypoint(35, 11),
      level3Waypoint(30, 11),
    ],
  }),
  createGuard({
    ...
    waypoints: [
      level3Waypoint(46, 8),
      level3Waypoint(55, 8),
      level3Waypoint(55, 12),
      level3Waypoint(46, 12),
    ],
  }),
  createGuard({
    name: "Vault Patrol",
    ...
    fovDeg: 74,
    waypoints: [
      level3Waypoint(52, 16),
      level3Waypoint(60, 16),
      level3Waypoint(60, 9),
      level3Waypoint(55, 9),
      level3Waypoint(52, 16),
    ],
  ...
  createGuard({
    ...
    fovDeg: 70,
    waypoints: [
      level3Waypoint(52, 30),
      level3Waypoint(61, 30),
      level3Waypoint(61, 34),
      level3Waypoint(52, 34),
    ],
  }),
];
